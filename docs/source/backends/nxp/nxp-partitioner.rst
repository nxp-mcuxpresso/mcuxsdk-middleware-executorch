...
* `neutron_converter_flavor` - Flavor of the neutron-converter module to use. Neutron-converter module named neutron_converter_SDK_26_03' has flavor 'SDK_26_03'. You shall set the flavour to the MCUXpresso SDK version you will use.
