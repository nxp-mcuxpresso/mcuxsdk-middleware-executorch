...
Visit [ExecuTorch - Documentation](https://mcuxpresso.nxp.com/mcuxsdk/latest/html/middleware/eiq/executorch/docs/nxp/ugindex.html) to review details on the contents in this sub-repo.
