...
## Installation
To use the ExecuTorch with the Neutron Backend you will need:
* ExecuTorch from the https://github.com/nxp-mcuxpresso/mcuxsdk-middleware-executorch.git
* eIQ Neutron SDK
* MCUXpresso
...
#### Installation
The Neutron Converter and the Neutron Simulator are available as a Python packages and can be installed by the `pip` command from eiq.nxp.com/repository:
```commandline
