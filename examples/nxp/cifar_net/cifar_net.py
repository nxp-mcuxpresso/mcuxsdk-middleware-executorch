...
class CifarNetModel(nn.Module):
    ...
    def forward(self, x):
        ...
        # The `Reshape` is not in the TFLite variant, but must be present here.
...
def get_model(batch_size: int = 1, state_dict_file: str | None = None, train: bool = False,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--pth-file', required=False, type=str,
    ...
    cifar_net = get_model(state_dict_file=args.pth_file, train=args.train, batch_size=args.batch_size,
