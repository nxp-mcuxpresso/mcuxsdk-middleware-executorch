...
class PayloadComposer:
    ...
    def _create_payload_header(self, io_formats, neutron_artifacts) -> np.ndarray:
        ...
        assert len(neutron_artifacts.input_indices) < 256, "Models with more than 255 inputs are not supported."
        assert len(neutron_artifacts.output_indices) < 256, "Models with more than 255 outputs are not supported."
